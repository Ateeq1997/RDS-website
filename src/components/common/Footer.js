...
const Footer = () => {
    return (
      ...
      <div className="footer-buttons">
        ...
        <Link to="/requestademo" className="footer-button">
                    ...
                    <div className="footer-links">
                        <div className="services">
                            ...
                            <li><Link to="/revenue-cycle-management">Revenue Cycle Management</Link></li>
                                <li><Link to="/healthcare-digital-marketing">Healthcare Digital Marketing</Link></li>
                                <li><Link to="/healthcare-analytics">Healthcare Analytics</Link></li>
                                <li><Link to="/patient-experience-management">Patient Experience Management</Link></li>
                        ...
                        <div className="legal-notice">
                            <h4>Legal notice</h4>
                            <ul>
                                <li><Link to="/requestademo">Privacy Policy</Link></li>
                                <li><Link to="/requestademo">Non-Discrimination</Link></li>
                                <li><Link to="/requestademo">Contact</Link></li>
                            </ul>
                        </div>
                        <div className="explore">
                            <h4>Explore</h4>
                            <ul>
                            <li><Link to="/requestademo">Book a Call</Link></li>
                            <li><Link to="/requestademo">News</Link></li>
                            </ul>
                        </div>
                    </div>
                </div>
